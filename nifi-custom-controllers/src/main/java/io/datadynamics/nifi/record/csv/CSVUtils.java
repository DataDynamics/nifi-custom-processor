...
public class CSVUtils {
    ...
    private static CSVFormat buildCustomFormat(final PropertyContext context, final Map<String, String> variables) {
        ...
        final Character escapeChar = context.getProperty(org.apache.nifi.csv.CSVUtils.ESCAPE_CHAR).evaluateAttributeExpressions(variables).getValue().isEmpty() ? null : getCharUnescaped(context, ESCAPE_CHAR, variables);
