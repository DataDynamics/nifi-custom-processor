...
public final class CSVParser implements Iterable<shaded.org.apache.commons.csv.CSVRecord>, Closeable {
     ...
     */
    public static CSVParser parse(final File file, final Charset charset, final shaded.org.apache.commons.csv.CSVFormat format) throws IOException {
     ...
     */
    @SuppressWarnings("resource")
    public static CSVParser parse(final InputStream inputStream, final Charset charset, final shaded.org.apache.commons.csv.CSVFormat format)
            throws IOException {
     ...
     */
    @SuppressWarnings("resource")
    public static CSVParser parse(final Path path, final Charset charset, final shaded.org.apache.commons.csv.CSVFormat format) throws IOException {
     ...
     * @since 1.5
     */
    public static CSVParser parse(final Reader reader, final shaded.org.apache.commons.csv.CSVFormat format) throws IOException {
     ...
     * @throws IOException              If an I/O error occurs
     */
    public static CSVParser parse(final String string, final shaded.org.apache.commons.csv.CSVFormat format) throws IOException {
     ...
     */
    @SuppressWarnings("resource")
    public static CSVParser parse(final URL url, final Charset charset, final shaded.org.apache.commons.csv.CSVFormat format) throws IOException {
