...
import static shaded.org.apache.commons.csv.Constants.BACKSPACE;
import static shaded.org.apache.commons.csv.Constants.CR;
import static shaded.org.apache.commons.csv.Constants.END_OF_STREAM;
import static shaded.org.apache.commons.csv.Constants.FF;
import static shaded.org.apache.commons.csv.Constants.LF;
import static shaded.org.apache.commons.csv.Constants.TAB;
import static shaded.org.apache.commons.csv.Constants.UNDEFINED;
import static shaded.org.apache.commons.csv.Token.Type.COMMENT;
import static shaded.org.apache.commons.csv.Token.Type.EOF;
import static shaded.org.apache.commons.csv.Token.Type.EORECORD;
...
final class Lexer implements Closeable {
    ...
    /** The input stream */
    private final shaded.org.apache.commons.csv.ExtendedBufferedReader reader;
    private String firstEol;

    private boolean isLastTokenDelimiter;

    Lexer(final CSVFormat format, final shaded.org.apache.commons.csv.ExtendedBufferedReader reader) {
        this.reader = reader;
    ...
    /**
     * Determine whether the next characters constitute a delimiter through {@link shaded.org.apache.commons.csv.ExtendedBufferedReader#lookAhead(char[])}.
     *
     * @param ch
    ...
    /**
     * Tests if the next characters constitute a escape delimiter through {@link shaded.org.apache.commons.csv.ExtendedBufferedReader#lookAhead(char[])}.
     *
     ...
     */
    shaded.org.apache.commons.csv.Token nextToken(final shaded.org.apache.commons.csv.Token token) throws IOException {
     ...
     */
    private shaded.org.apache.commons.csv.Token parseEncapsulatedToken(final shaded.org.apache.commons.csv.Token token) throws IOException {
        token.isQuoted = true;
     ...
     */
    private shaded.org.apache.commons.csv.Token parseSimpleToken(final shaded.org.apache.commons.csv.Token token, int ch) throws IOException {
    ...
    boolean readEndOfLine(int ch) throws IOException {
        ...
        if (ch == CR && reader.lookAhead() == LF) {
            ...
            // Save the EOL state
            if (firstEol == null) {
                this.firstEol = shaded.org.apache.commons.csv.Constants.CRLF;
            }
        }
        // save EOL state here.
        if (firstEol == null) {
     ...
     * On return, the next character is available by calling {@link shaded.org.apache.commons.csv.ExtendedBufferedReader#getLastChar()}
     * on the input stream.
     *
     * @return the unescaped character (as an int) or {@link shaded.org.apache.commons.csv.Constants#END_OF_STREAM} if char following the escape is
     *      invalid.
