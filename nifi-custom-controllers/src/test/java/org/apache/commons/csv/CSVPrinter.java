...
/**
 * Prints values in a {@link shaded.org.apache.commons.csv.CSVFormat CSV format}.
 *
 ...
 * However a comment will only be written to the output if the {@link shaded.org.apache.commons.csv.CSVFormat} supports comments.
 * </p>
 *
...
public final class CSVPrinter implements Flushable, Closeable {
     ...
     */
    public CSVPrinter(final Appendable appendable, final shaded.org.apache.commons.csv.CSVFormat format) throws IOException {
    ...
    public synchronized void printRecord(final Stream<?> values) throws IOException {
        values.forEachOrdered(t -> {
            try {
                ...
                throw shaded.org.apache.commons.csv.IOUtils.rethrow(e);
            }
        });
        println();
    }
