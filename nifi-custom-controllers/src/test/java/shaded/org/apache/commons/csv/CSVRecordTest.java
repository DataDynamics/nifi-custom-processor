...
public class CSVRecordTest {
    ...
    private shaded.org.apache.commons.csv.CSVRecord record, recordWithHeader;
    ...
    public void setUp() throws Exception {
        ...
        try (final shaded.org.apache.commons.csv.CSVParser parser = shaded.org.apache.commons.csv.CSVFormat.DEFAULT.parse(new StringReader(rowData))) {
            record = parser.iterator().next();
        }
        try (final shaded.org.apache.commons.csv.CSVParser parser = shaded.org.apache.commons.csv.CSVFormat.DEFAULT.builder().setHeader(EnumHeader.class).build().parse(new StringReader(rowData))) {
    ...
    public void testCSVRecordNULLValues() throws IOException {
        final shaded.org.apache.commons.csv.CSVParser parser = shaded.org.apache.commons.csv.CSVParser.parse("A,B\r\nONE,TWO", shaded.org.apache.commons.csv.CSVFormat.DEFAULT.withHeader());
        final shaded.org.apache.commons.csv.CSVRecord csvRecord = new shaded.org.apache.commons.csv.CSVRecord(parser, null, null, 0L, 0L);
    ...
    public void testIsInconsistent() throws IOException {
        ...
        final String rowData = StringUtils.join(values, ',');
        try (final shaded.org.apache.commons.csv.CSVParser parser = shaded.org.apache.commons.csv.CSVFormat.DEFAULT.withHeader(headers).parse(new StringReader(rowData))) {
            final Map<String, Integer> map = parser.getHeaderMapRaw();
            final shaded.org.apache.commons.csv.CSVRecord record1 = parser.iterator().next();
            map.put("fourth", Integer.valueOf(4));
    ...
    public void testRemoveAndAddColumns() throws IOException {
        // do:
        try (final shaded.org.apache.commons.csv.CSVPrinter printer = new CSVPrinter(new StringBuilder(), shaded.org.apache.commons.csv.CSVFormat.DEFAULT)) {
            ...
            assertEquals("A,B,C,NewValue" + shaded.org.apache.commons.csv.CSVFormat.DEFAULT.getRecordSeparator(), printer.getOut().toString());
        }
    }

    @Test
    public void testSerialization() throws IOException, ClassNotFoundException {
        final shaded.org.apache.commons.csv.CSVRecord shortRec;
        try (final shaded.org.apache.commons.csv.CSVParser parser = shaded.org.apache.commons.csv.CSVParser.parse("A,B\n#my comment\nOne,Two", shaded.org.apache.commons.csv.CSVFormat.DEFAULT.withHeader().withCommentMarker('#'))) {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(in)) {
            ...
            assertTrue(object instanceof shaded.org.apache.commons.csv.CSVRecord);
            final shaded.org.apache.commons.csv.CSVRecord rec = (shaded.org.apache.commons.csv.CSVRecord) object;
    ...
    public void testToMapWithNoHeader() throws Exception {
        try (final shaded.org.apache.commons.csv.CSVParser parser = shaded.org.apache.commons.csv.CSVParser.parse("a,b", shaded.org.apache.commons.csv.CSVFormat.newFormat(','))) {
            final shaded.org.apache.commons.csv.CSVRecord shortRec = parser.iterator().next();
    ...
    public void testToMapWithShortRecord() throws Exception {
        try (final shaded.org.apache.commons.csv.CSVParser parser = CSVParser.parse("a,b", CSVFormat.DEFAULT.withHeader("A", "B", "C"))) {
