...
/**
 * Test {@link shaded.org.apache.commons.csv.ExtendedBufferedReader}.
 */
public class ExtendedBufferedReaderTest {

    private shaded.org.apache.commons.csv.ExtendedBufferedReader createBufferedReader(final String s) {
        return new shaded.org.apache.commons.csv.ExtendedBufferedReader(new StringReader(s));
    }

    @Test
    public void testEmptyInput() throws Exception {
        try (final shaded.org.apache.commons.csv.ExtendedBufferedReader br = createBufferedReader("")) {
    ...
    public void testReadChar() throws Exception {
        ...
        try (final shaded.org.apache.commons.csv.ExtendedBufferedReader br = createBufferedReader(test)) {
    ...
    public void testReadingInDifferentBuffer() throws Exception {
        ...
        try (shaded.org.apache.commons.csv.ExtendedBufferedReader reader = createBufferedReader("1\r\n2\r\n")) {
    ...
    public void testReadLine() throws Exception {
        ...
        try (final shaded.org.apache.commons.csv.ExtendedBufferedReader br = createBufferedReader("foo\n\nhello")) {
            assertEquals(0, br.getCurrentLineNumber());
        ...
        try (final shaded.org.apache.commons.csv.ExtendedBufferedReader br = createBufferedReader("foo\rbaar\r\nfoo")) {
            assertEquals("foo", br.readLine());
    ...
    public void testReadLookahead1() throws Exception {
        try (final shaded.org.apache.commons.csv.ExtendedBufferedReader br = createBufferedReader("1\n2\r3\n")) {
            assertEquals(0, br.getCurrentLineNumber());
    ...
    public void testReadLookahead2() throws Exception {
        ...
        try (final shaded.org.apache.commons.csv.ExtendedBufferedReader br = createBufferedReader("abcdefg")) {
            ref[0] = 'a';
            ref[1] = 'b';
            ref[2] = 'c';
